  ...
  return (
    <>
      <div className="timer-values">
        <div className="timer-value">{formattedDays}</div>
        <div className="timer-value">{formattedHours}</div>
        <div className="timer-value">{formattedMinutes}</div>
        <div className="timer-value">{formattedSeconds}</div>
      </div>
